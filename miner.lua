...
local VERSION = 110
local STATE_FILE = "miner_state_v110"
...
--
-- Das gewuenschte Item wird innerhalb der Kiste auf Slot 1
-- verschoben.
--
-- Danach zieht turtle.suck() genau dieses Item.
--
-- Dadurch funktionieren gemischte Kisten.
-- ============================================================
...
local function pullNamed(
    ...
    and attempts < 128 do
        ...
        -- ====================================================
        -- Gewuenschtes Item bereits in Slot 1.
        -- ====================================================
        ...
        if sourceSlot == 1 then
            ...
            -- =================================================
            -- Slot 1 muss zuerst freigemacht werden.
            -- =================================================
        ...
        -- ====================================================
        -- Jetzt befindet sich das Item in Kistenslot 1.
        -- ====================================================
...
-- ============================================================
-- FALLBACK FÜR KISTE OHNE PERIPHERAL
-- ============================================================

function pullNamedFallback(
    name,
    amount
)
...
--       ->
--
-- Dadurch bleibt die Turtle am Ende exakt auf ihrer
-- eigentlichen Mining-Position.
-- ============================================================
...
local function placeTorchBehind()
    ...
    -- ========================================================
    -- Gibt es hinter der Turtle eine gueltige Position?
    -- ========================================================

    if state.currentRow % 2 == 1 then

        -- Ungerade Reihe -> +X
        -- Hinter der Turtle liegt col - 1.

        if state.currentCol <= 1 then

            -- Noch keine gueltige Position hinter uns.
    ...
    -- ========================================================
    -- PRUEFEN, OB BEREITS EINE FACKEL DA IST
    -- ========================================================
...
local function recoverTorch()
    ...
    -- Phase 1:
    -- Programm wurde beendet, bevor die Rueckwaertsbewegung
    -- stattgefunden hat.
    ...
    -- Phase 2:
    -- Turtle steht auf der Position hinter der eigentlichen
    -- Arbeitsposition.
...
--   forward
--
-- Dadurch wurde der obere Block der letzten Position
-- nicht mehr erreicht.
--
-- NEU:
--
...
--   Fackel
--
-- Dadurch wird IMMER der obere Block der Position abgebaut,
-- auf der die Turtle gerade steht.
-- ============================================================
...
local function mineAhead(
    ...
    -- ========================================================
    -- 1. Block vor der Turtle abbauen.
    -- ========================================================
    ...
    -- ========================================================
    -- 3. Position JETZT aktualisieren.
    -- ========================================================
    ...
    -- 4. WICHTIG:
    --
    -- Der obere Block wird ERST JETZT abgebaut.
    --
    -- Damit wird auch der letzte Block einer Reihe
    -- korrekt oben geoeffnet.
    -- ========================================================
...
local function enterNextRow(
    ...
    -- ========================================================
    -- Der erste Block der neuen Reihe steht bereits unter
    -- der Turtle.
    --
    -- Deshalb direkt OBEN abbauen.
    -- ========================================================
...
local function mineLayer(
    ...
    if state.currentLayer ~= layer then
        ...
        -- Zurueck zum Startpunkt des Layers.
...
local function newJob()
    ...
    -- START-SERVICE
    --
    -- Genau hier werden die Vorräte beim Start
...
local function resume()
    ...
    if state == nil then
        ...
        print("")
        print("Kein gueltiger V11 Auftrag vorhanden.")
        print("")
